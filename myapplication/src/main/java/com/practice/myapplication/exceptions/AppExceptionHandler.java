...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> HandleAppException(Exception ex, WebRequest webRequest)
    {
    ...
    public ResponseEntity<ExceptionResponse> HandleNullPointerException(NullPointerException ex, WebRequest webRequest)
    {
        String nullPointerExceptionMessage = ex.getLocalizedMessage();

        if(nullPointerExceptionMessage==null)
            nullPointerExceptionMessage = ex.toString();

        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(),nullPointerExceptionMessage);
        return new ResponseEntity<>(exceptionResponse,HttpStatus.INTERNAL_SERVER_ERROR);
    }
